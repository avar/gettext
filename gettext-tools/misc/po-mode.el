...
(defcustom po-auto-replace-file-header t
...
(defun po-check-file-header ()
  "Create a missing PO mode file header, or replace an oldish
one.  Can be customized with the `po-auto-replace-file-header'
variable."
  (if (or (eq po-auto-replace-file-header t)
          (and (eq po-auto-replace-file-header 'ask)
